...
*/
var api = new simpay.API({key: '333333333333333333333333', secret: '2222222222222222222', version: '1'});
...
*/
api.getStatus({serviceId: '211', number: '7055', code: 'F713EE'}, function(isOk, errorType, err) {
	console.log(isOk);
